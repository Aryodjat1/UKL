...
if (isset($_POST['tambahsiswa'])) {
    ...
    $query_run = mysqli_query($conn, "INSERT INTO siswa (nisn, nis, nama, password, id_kelas, alamat, no_tlp, level) VALUES ('$nisn', '$nis', '$nama', '$password', '$id_kelas', '$alamat', '$no_tlp', '$level')");
